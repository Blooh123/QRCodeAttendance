    ...
    <section class="hero-gradient text-white py-20 mobile-hero">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center" data-aos="fade-up" data-aos-duration="1000">
                <h1 class="text-4xl md:text-6xl font-bold mb-6 mobile-text" data-aos="fade-up" data-aos-delay="200">
                    Secure Attendance Management
                </h1>
                <p class="text-xl md:text-2xl mb-8 max-w-3xl mx-auto mobile-subtitle" data-aos="fade-up" data-aos-delay="400">
    ...
    <section id="system-overview" class="py-20 bg-white">
        <div class="max-w-4xl mx-auto" data-aos="zoom-in" data-aos-duration="1000">
            ...
            <div class="video-container">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/F8xpmTmdf6o?si=saEwbDG79HkpeZHW" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
    ...
    <section class="py-20 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                <div class="bg-white rounded-xl p-8 feature-card" data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="bg-white rounded-xl p-8 feature-card" data-aos="fade-up" data-aos-delay="400">
                ...
                <div class="bg-white rounded-xl p-8 feature-card" data-aos="fade-up" data-aos-delay="600">
                ...
                <div class="bg-white rounded-xl p-8 feature-card" data-aos="fade-up" data-aos-delay="800">
                ...
                <div class="bg-white rounded-xl p-8 feature-card" data-aos="fade-up" data-aos-delay="1000">
