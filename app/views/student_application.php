...
<header class="bg-white/90 backdrop-blur-lg shadow-md rounded-2xl p-6 mb-8 max-w-7xl mx-auto glass-card">
    <div class="flex items-center justify-between">
        ...
        <div class="flex items-center gap-4">
            <p class="hidden md:block text-sm text-gray-600">To excuse a student from a specific event, open the excuse workspace.</p>
            <a href="<?= ROOT ?>view_application" class="bg-[#a31d1d] hover:bg-[#8a1818] text-white px-4 py-2 rounded-xl font-semibold shadow-[0px_4px_0px_1px_rgba(0,0,0,1)] outline outline-1 outline-black transition-all duration-200 flex items-center gap-2 whitespace-nowrap">
